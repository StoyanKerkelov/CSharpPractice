...
using System.Threading.Tasks;
    ...
    /*Live demo: Parse a markdown text. All text between ** ** should be uppercase. All text between ticks(`)
     *  should be lowercase. All text between _ _ should be mixed case.*/

    // all text between ** ** should be uppercase
    // all text between `` should be lowercase
    // all text between _ _ should be mixed case

namespace _5.CaseTransformations
{
    class Program
    {
