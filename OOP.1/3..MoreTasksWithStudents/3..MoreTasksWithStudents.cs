...
class MoreTasksWithStudents
{
    static void Main()
    {
        ...
        #region Task 18
        //Use LINQ to extracts all students grouped by GroupNumber and then prints them to the console.

        var groupedByGroupNumber = //in Group class
            from stud in students
        ...
        var groupedByGroupNumberExt = students.GroupBy(s => s.GroupNumber).OrderBy(k => k.Key);//in Group class
